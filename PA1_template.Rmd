...
#### 3. Mean and median number of steps taken each day. Code below calculates mean and median number of steps taken each day but results are not reported at this step
...
sprintf("The 5-minute interval that, on average, contains the maximum number of steps: %d",intervalMeanMax)
```
